...
## Commented since these assets were used by RoboTutor team for Swahili version of the application
...
## Commented since this application is not required for localization
